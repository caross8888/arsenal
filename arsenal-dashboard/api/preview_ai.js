...
//
// vercel.json의 crons가 하루 두 번 부른다(06시·23시, 한국시간). 무료 플랜은 크론 하나당
// 하루 1회가 상한이라, 같은 엔드포인트를 가리키는 항목을 두 개 둔다(프로젝트당 100개까지 허용).
// 시각은 실측으로 정했다 — 부상 소식은 한국시간 저녁~밤(18~23시)에 가장 많고(최근 1주 기준 18건 중 7건,
// 단일 최다는 22시), 오전 6~11시가 가장 한산하다(2건). 영국 근무시간이 한국시간 17~02시이기 때문.
// 크론은 ±59분 오차가 있어서 23시 크론은 23:00~23:59 사이에 돌고, 22시대 소식까지 받아간다. 모달을 열 때 생성하면 그 경기를 처음 여는
